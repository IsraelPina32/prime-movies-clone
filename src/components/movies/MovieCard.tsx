...
export   const  MovieCard: React.FC<MovieCardProps> = ({ movie }) => {
  ...
  return (
    <article className="relative group bg-[#1a242f] rounded-lg overflow-hidden isolate transition-all duration-300 hover:scale-105 shadow-2xl transform-gpu border border-white/5">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#0f171e] via-transparent to-transparent opacity-100 group-hover:opacity-80 transition-opacity duration-500 pointer-events-none"/>
